fetch("https://jsonplaceholder.typicode.com/photos")
    ...
    .then((photos) => {
        ...
        const mainContainer = document.querySelector('.photos-container');
...
fetch("https://jsonplaceholder.typicode.com/comments")
    ...
    .then((comments) => {
        if (document.querySelectorAll('.gray').length >= 2) {
            ...
            commentSpan2.textContent = comments[1].name + ': ';
            const commentText2 = document.createElement('b');
            commentText2.textContent = comments[1].body;
            ...
            const existingCommentDiv1 = document.querySelectorAll('.gray')[0];
            existingCommentDiv1.parentNode.insertBefore(commentDiv1, existingCommentDiv1);
            existingCommentDiv1.parentNode.insertBefore(grayDiv1, existingCommentDiv1.nextSibling);

            const existingCommentDiv2 = document.querySelectorAll('.gray')[1];
            existingCommentDiv2.parentNode.insertBefore(commentDiv2, existingCommentDiv2);
            existingCommentDiv2.parentNode.insertBefore(grayDiv2, existingCommentDiv2.nextSibling);
        }
    });
